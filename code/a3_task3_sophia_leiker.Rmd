...
ggplot(data = total_purple, aes(x= year, y = total, fill = site_full)) +
  ...
  labs(x = "Urchin Count", y = "Year", title = "Count of Purple Urchins Recorded at Each Site Across Years", subtitle = "Data from Reed, D. 2020. SBC LTER: Reef: Long-term experiment") +
  theme_minimal() +
